...
// Generates a massive paragraph of scientific filler text
function generateScientificFiller(paragraphsCount) {
    const filler = "Ground spiders (Order Araneae) act as an indispensable predatory force in terrestrial ecosystems. Any anthropogenic disturbance that alters their microhabitat architecture significantly reduces their species richness, ultimately leading to a collapse in local insect population control mechanisms. The University of Dodoma (UDOM), located in the semi-arid region of central Tanzania, features a unique landscape characterized by both highly disturbed construction zones and relatively pristine, undisturbed savanna woodlands. Understanding the abundance and diversity of ground-dwelling spiders in these contrasting habitats provides critical insights into the ecological health of the university campus. Disturbed habitats typically experience soil compaction, vegetation clearing, and chemical run-offs which directly impact arachnid survival rates. Furthermore, variations in soil pH, moisture content, and organic leaf litter depth play a crucial role in web-building and hunting spider distributions. Ground-dwelling species such as those in the families Lycosidae (wolf spiders) and Gnaphosidae are particularly vulnerable to trampling and habitat fragmentation. This study aims to quantify these exact environmental pressures across multiple sampling transects spanning over 60 hectares of university grounds. ";
...
const ast = {
  ...
  Document_Tree: [
    ...
    { tag: "Page_Break" },
    {
      tag: "Kichwa_Kuu",
      style: { font: "Times New Roman", size: 14, bold: true, align: "center", marginBottom: "20px" },
      content: "CHAPTER TWO: LITERATURE REVIEW (MASSIVE DATA)"
    },
    ...generateScientificFiller(250), // Generates ~250 paragraphs of thick academic text (approx 35,000 words / ~60+ pages)
    { tag: "Page_Break" },
    {
      tag: "Kichwa_Kuu",
      style: { font: "Times New Roman", size: 14, bold: true, align: "center", marginBottom: "20px" },
      content: "CHAPTER THREE: METHODOLOGY & TRACKING"
    },
    {
      tag: "Box",
      style: { border: "1px solid #cbd5e1", padding: "20px", borderRadius: "8px", backgroundColor: "#f1f5f9", marginBottom: "30px" },
      children: [
        {
          tag: "Kichwa_Dogo",
          ...
          children: [
            {
              ...
              children: [
                { tag: "TableCell", style: { padding: "10px", border: "1px solid #94a3b8", borderStyle: "double" }, content: "Status" },
                { tag: "TableCell", style: { padding: "10px", border: "1px solid #94a3b8", borderStyle: "double" }, content: "Specific Objective" },
                { tag: "TableCell", style: { padding: "10px", border: "1px solid #94a3b8", borderStyle: "double" }, content: "Target Habitat" }
              ]
            },
            {
              tag: "TableRow",
              children: [
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8", align: "center" }, children: [{ tag: "Icon", name: "tick", color: "#16a34a", size: 20 }] },
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8" }, content: "Determine ground spider species richness." },
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8" }, content: "All Areas" }
              ]
            },
            {
              tag: "TableRow",
              children: [
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8", align: "center" }, children: [{ tag: "Icon", name: "tick", color: "#16a34a", size: 20 }] },
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8" }, content: "Compare abundance between disturbed & undisturbed." },
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8" }, content: "CNMS & CIVE bushes" }
              ]
            },
            {
              tag: "TableRow",
              children: [
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8", align: "center" }, children: [{ tag: "Icon", name: "cross", color: "#dc2626", size: 20 }] },
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8" }, content: "Analyze soil pH impact on web-building spiders." },
                { tag: "TableCell", style: { padding: "10px", border: "1px dashed #94a3b8" }, content: "Pending Lab Data" }
              ]
            }
          ]
        }
...
// Write to JSON file to bypass string limit issues in the UI payload logic if necessary
fs.writeFileSync('ai-word-formatter/public/massive_payload.json', JSON.stringify(ast, null, 2));
console.log("Massive JSON generated successfully: massive_payload.json");
